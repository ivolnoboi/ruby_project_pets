...
image1 = Image.create(path: 'E:\rub\image\cat.jpg')
image2 = Image.create(path: 'E:\rub\image\dog.jpg')
image3 = Image.create(path: 'E:\rub\image\event.jpg')
event1 = Event.create(title: 'Сбор пожертвований', event_date: '2019-12-07 12:00:00', user: user1, location: location1, event_description: 'Данное событие предназначено для сбора пожертвований для приюта "Собаки и коты"')
...
pet1.avatars.attach(io: File.open('E:\rub\untitled\app\assets\images\dog.jpg'), filename: 'dog.jpg')
pet2.avatars.attach(io: File.open('E:\rub\untitled\app\assets\images\cat.jpg'), filename: 'cat.jpg')
event2.avatar.attach(io: File.open('E:\rub\untitled\app\assets\images\event.jpg'), filename: 'event.jpg')
